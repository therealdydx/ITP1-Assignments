...
Officer: 3185280
CaseNum: 402-2-86165327-3185280
...
function draw()
{
	...
	///////////////////ADD YOUR CODE HERE///////////////////
	if (det.locationX < 261)
	{
		det.speedX = 1;
		det.speedY = 0;
	}
    if (det.locationX == 260 && det.locationY > 70)
    {
        det.speedX = 0;
        det.speedY = 1;
    }
    if (det.locationX < 572 && det.locationY == 318)
    {
        det.speedX = 1;
        det.speedY = 0;
    }
    if (det.locationX == 570 && det.locationY > 317)
    {
        det.speedX = 0;
        det.speedY = 1;
    }
    if (det.locationX < 889 && det.locationY == 508)
    {
        det.speedX = 1;
        det.speedY = 0;
    }
    if (det.locationX == 887 && det.locationY > 507)
    {
        det.speedX = 0;
        det.speedY = 1;
    }
